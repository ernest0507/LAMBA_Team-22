...
As a car owner, I want to upload receipts, documents as PDFs so that important proof of repairs and expenses is not lost
...
As a car owner, I want to customize a simple digital twin of my car, such as colour and body type, so that the application feels more personal and connected to my real vehicle

### Notes and constraints

Constraint: it is difficult to provide the ability to customize a digital twin for every car for the first time


## US-08: Several owners of the car
**Requirement status:** Active
...
How many users can share the one digital twin?


## US-09: Automatically recognize text from images
**Requirement status:** Active

**MoSCoW priority:** Could Have

As a car owner, I want that application to automatically recognize text from images of documents in a digital format, so that it is easier to view data instead of images

### Notes and constraints

Constrained: the accuracy of recognized text may not be 100%

## US-10: Voice chat with AI-agent
**Requirement status:** Active

**MoSCoW priority:** Could Have

As a car owner, I would like to send audio messages to an AI agent, so that it can expand the functionality for interacting with the AI agent
