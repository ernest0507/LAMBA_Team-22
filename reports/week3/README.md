...
Current linked Sprint items:

- [US-01: Storing car's data](https://github.com/ernest0507/LAMBA_Team-22/issues/31)
- [PBI - Integrating the chat with AI-assistant](https://github.com/ernest0507/LAMBA_Team-22/issues/49)
- [PBI - Implement MVP v1 navigation between screens](https://github.com/ernest0507/LAMBA_Team-22/issues/51)
...
Verification evidence for MVP v1 PBIs is still being collected because development work is not fully finished yet. Final links to related PRs, screenshots, test evidence, or demo timestamps will be added before final submission.

| PBI / User Story | Verification Evidence |
|---|---|
| [US-01: Storing car's data](https://github.com/ernest0507/LAMBA_Team-22/issues/31) | **PLACEHOLDER — add related PR, screenshot, test evidence, or demo timestamp before final submission.** |
| [PBI - Integrating the chat with AI-assistant](https://github.com/ernest0507/LAMBA_Team-22/issues/49) | **PLACEHOLDER — add related PR, screenshot, test evidence, integration note, or demo timestamp before final submission.** |
| [PBI - Implement MVP v1 navigation between screens](https://github.com/ernest0507/LAMBA_Team-22/issues/51) | **PLACEHOLDER — add related PR, navigation screenshot, test evidence, or demo timestamp before final submission.** |

## Current Product Status

MVP v1 is currently in active development and integration.

The team has already prepared the Week 3 reporting structure, updated the roadmap, added customer review materials, and collected initial screenshots for backlog, milestone, and review evidence. Product work is focused on connecting backend functionality, improving the frontend design, and implementing the main MVP navigation flow.

Current status:

- backend connection work has been started and partially integrated;
- frontend design has been updated;
- main MVP navigation work is in progress;
- AI assistant integration is still being finalized;
...
- SemVer release, runnable artifact, and public demo video will be added after MVP v1 delivery is finalized.

## Next Steps

The team will:

- finalize MVP v1 implementation and verification;
- publish the SemVer release for MVP v1;
- provide a runnable artifact or equivalent access point;
- record and publish the public sanitized MVP v1 demo video under two minutes;
- update the README with final Story Point totals;
- link final reviewed PRs/MRs created during Week 3;
- update contribution traceability with final issue, PR, and review links;
- add missing screenshots for release, delivered MVP v1, and MVP v1 scope view if they become available before final submission.
...
- **SemVer release mapped to MVP v1:** **PLACEHOLDER — add release link here after MVP v1 release is published.**
- **Delivered MVP v1 deployment / runnable artifact:** **PLACEHOLDER — add runnable artifact, build, APK, or deployment link here.**
- **Public sanitized video demonstration under two minutes:** **PLACEHOLDER — add demo video link here.**
- [CHANGELOG.md](https://github.com/ernest0507/LAMBA_Team-22/blob/main/CHANGELOG.md)
...
- [Issue templates](https://github.com/ernest0507/LAMBA_Team-22/tree/main/.github/ISSUE_TEMPLATE)
- [Extended PR/MR template](https://github.com/ernest0507/LAMBA_Team-22/blob/main/.github/pull_request_template.md)
- **Reviewed issue-linked PRs/MRs created during Week 3:** **PLACEHOLDER — add final reviewed PR/MR links here.**
...
**PLACEHOLDER — add screenshot after the MVP v1 scope view is finalized.**  
Expected file name: `reports/week3/images/mvp-version-view.png`

<!-- Add after screenshot exists:
![MVP version view](./images/mvp-version-view.png)
-->

### SemVer release

**PLACEHOLDER — add screenshot after the MVP v1 release is published.**  
Expected file name: `reports/week3/images/semver-release.png`
...
**PLACEHOLDER — add screenshot after the runnable MVP v1 artifact is finalized.**  
Expected file name: `reports/week3/images/delivered-mvp-v1.png`
